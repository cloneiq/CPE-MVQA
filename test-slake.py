...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='data_Slake', help='Root data directory')
    parser.add_argument('--image_dir', type=str, default='data_Slake/imgs', help='Image directory')
    parser.add_argument('--test_json', type=str, default='data_Slake/test.jsonl', help='Test data JSON/JSONL')
    ...
    parser.add_argument('--embeddings_dir', type=str, default='data_Slake/embeddings_all', help='Embeddings directory')
    parser.add_argument('--roberta_path', type=str, default='/root/autodl-tmp/baseline/CIMB-MVQA-main/roberta-base',
    ...
    parser.add_argument('--do_ccs_margin', type=float, default=0.05, help='Hard DO trigger margin: apply when ccs < -margin')
    parser.add_argument('--do_keep_base', type=float, default=0.55, help='Conservative mask scaling keep_base')
    parser.add_argument(
    ...
    parser.add_argument('--dynamic_causal_alpha', type=int, default=0, help='与训练 --dynamic_causal_alpha 一致')
    ...
    parser.add_argument(
        ...
        type=str,
        default='cache_Slake/test_causal_cache.json',
    ...
    parser.add_argument('--use_moe_router', type=int, default=1, help='1=与训练一致 MoE router + 稀疏因果子集')
